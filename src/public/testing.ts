...
export let TEST = [
	{
		...
		share_path: '/pages/selftest/index?type=001&name=抑郁测评专业版',
		share_url:
	...
	},
	{
		...
		share_path: '/pages/selftest/index?type=002&name=男性功能测试',
		share_url:
	...
	},
	{
		...
		share_path: '/pages/selftest/index?type=003&name=失眠程度测评',
		share_url:
